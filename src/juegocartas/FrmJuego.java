...
public class FrmJuego extends javax.swing.JFrame {
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        int bis = tpJugadores.getSelectedIndex();
        String antigua = "";
        
        switch (bis) {
            case 0:
                antigua = jugador1.getEscaleras();
                break;
            case 1:
                antigua = jugador2.getEscaleras();
                break;
        
        }
        
        JOptionPane.showMessageDialog(null, antigua);

        int tres = tpJugadores.getSelectedIndex();
        String ca = "";
        
        switch (tres) {
            case 0:
                ca = jugador1.getSumaTotal();
                break;
            case 1:
                ca = jugador2.getSumaTotal();
                break;
